                                            ...
                                            <Popover key={sectionIdx} className="px-4 relative inline-block text-left">
                                                <Popover.Button className="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900">
                                                    ...
                                                    {section.options.filter(option => option.checked).length
                                                        ?
                                                        (<span className="ml-1.5 rounded py-0.5 px-1.5 bg-gray-200 text-xs font-semibold text-gray-700 tabular-nums">{section.options.filter(option => option.checked).length}</span>)
                                                        :
                                                        null}
                                                    <ChevronDownIcon
