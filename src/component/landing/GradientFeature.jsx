...
const features = [
  {
    ...
    icon: <Icon icon="medical-icon:i-ambulance" className="h-6 w-6 text-white" aria-hidden="true" />,
  },
  {
    name: 'Área de Recuperación',
    description: 'Tenemos una área especial para los pacientes despúes de quírofano.',
    icon: <Icon icon="medical-icon:i-inpatient" className="h-6 w-6 text-white" aria-hidden="true" />,
  },
  {
    name: 'Laboratorio',
    description: 'Obten alguno de los estudios clínicos para monitorer el estado de salud.',
    icon: <Icon icon="medical-icon:i-laboratory" className="h-6 w-6 text-white" aria-hidden="true" />,
  },
  {
    name: 'Quirófano',
    description: 'Contamos con distintas salas para la operación de los pacientes.',
    icon: <Icon icon="medical-icon:i-surgery" className="h-6 w-6 text-white" aria-hidden="true" />,
  },
  {
    ...
    icon: <Icon icon="medical-icon:i-care-staff-area" className="h-6 w-6 text-white" aria-hidden="true" />,
  },
  {
    name: 'Imagenología',
    description: 'Poseemos equipo para obtener imágenes de áreas del interior del cuerpo.',
    icon: <Icon icon="medical-icon:i-cath-lab" className="h-6 w-6 text-white" aria-hidden="true" />,
  },
  {
    name: 'Farmacia',
    description: 'Obtén tus medicamentos necesarios en nuestra farmacia.',
    icon: <Icon icon="medical-icon:i-health-services" className="h-6 w-6 text-white" aria-hidden="true" />,
  },
  {
    name: 'Área de Tococirugía',
    description: 'Disponemos con una área para uso exclusivo para el parto y mujeres embarazadas.',
    icon: <Icon icon="medical-icon:i-ultrasound" className="h-6 w-6 text-white" aria-hidden="true" />,
  },
]
