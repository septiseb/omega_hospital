        ...
        <div id={id} className="relative py-16 bg-white">
            ...
            <div className="max-w-7xl mx-auto bg-sky-700 lg:bg-transparent lg:px-8">
                <div className="lg:grid lg:grid-cols-12">
                    <div className={`relative z-10 lg:col-start-${idx%2 ? 1 : 9} lg:row-start-1 lg:col-span-4 lg:py-16 lg:bg-transparent`}>
                    ...
                    <div className={`relative bg-sky-700 lg:col-start-${idx%2 ? 3 : 1 } lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center`}>
                        ...
                        <div className={`relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-${idx%2 ? 4 :2} lg:col-span-6`}>
