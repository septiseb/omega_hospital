...
const services = [
    ...
    },
    {
        ...
        id:"uci", title: "Terapia Intensiva", description: "Brindamos atención a pacientes que tienen alguna condición de salud que pone en riesgo la vida y por tal razón necesitan control y monitorización permanente.", img: require("../../utils/img/servicios/urgencias.jpeg")
    }, {
        id:"pediatria", title: "Pediatría", description: " Ofrecemos la especialdiad médica enfocada en la salud y las enfermedades de los niños. Se trata de una especialidad médica que se centra en los pacientes desde el momento del nacimiento hasta la adolescencia, sin que exista un límite preciso que determine el final de su validez.", img: require("../../utils/img/servicios/urgencias.jpeg")
    }, {
        id:"ginecologia",title: "Ginecología y Obstetricia", description: "Contamos con la especialidad médica que se especializa en brindar atención a las mujeres a lo largo de su vida, incluyendo el embarazo y el parto, además brindan diagnósticos y tratamientos para enfermedades de los órganos reproductores femeninos.", img: require("../../utils/img/servicios/urgencias.jpeg")
    }, {
        id:"traumatologia",title: "Traumatología y Ortopedia", description: "Tenemos servicios dedicados al diagnóstico, tratamiento, rehabilitación y prevención de lesiones y enfermedades que afectan al sistema músculo esquelético. Este complejo sistema abarca huesos, articulaciones, ligamentos, tendones, músculos y nervios.", img: require("../../utils/img/servicios/urgencias.jpeg")
    }, {
        id:"medicina",title: "Medicina Interna", description: "Existen dentro del hospital especialidades médicas que se encarga de la atención integral del adulto, así como del diagnóstico y tratamiento no quirúrgico y la prevención de las enfermedades. Lo más característico de esta especialidad es la visión global de la persona enferma", img: require("../../utils/img/servicios/urgencias.jpeg")
    },
    {
        id:"farmacia",title: "Farmacia", description: "Contamos especialmente con una unidad médica y personal responsable se encarga de la correcta conservación, custodia, organización y mantiene un sistema eficaz de dispensación de los medicamentos prescritos por el médico tratante de acuerdo a las instrucciones emitidas.", img: require("../../utils/img/servicios/urgencias.jpeg")
    }
]
